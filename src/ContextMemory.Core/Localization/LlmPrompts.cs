...
public static class LlmPrompts
{
    ...
    public static string WikiTicketDigest(string? language) =>
        TenantLocale.Select(
            ...
            Write at most 7 lines of plain text (no markdown fences, no JSON):
            ...
            - Lines 3–7: short factual bullets covering problem, decisions, and especially RULES found in comments/discussion
            ...
            Escreve no máximo 7 linhas de texto simples (sem fences markdown, sem JSON):
            ...
            - Linhas 3–7: factos curtos sobre problema, decisões e sobretudo REGRAS nos comentários/discussão
